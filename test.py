...
parser = argparse.ArgumentParser(description='Input question')
parser.add_argument('-q','--question', help='Enter the Question',
...
print("Predicted Question Type :",le.inverse_transform(np.argmax(model.predict(example))))
